...
outputFile="output/output_ParE3_"$size
alphFile="alphabet_ParE3_"$size
subInputFile="input_sub_ParE3_"$size
antipodFile="antipodal_seqs_ParE3_"$size
tmpFile="tmp_out_ParE3_"$size
echo -n > $outputFile
